...
if (CMAKE_BUILD_TYPE MATCHES Coverage)
  if (CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang|AppleClang")
    # when building with coverage suppport, the linker must also know about it
    SET(CMAKE_EXE_LINKER_FLAGS  "${CMAKE_EXE_LINKER_FLAGS} --coverage")
  else ()
    message(FATAL_ERROR "No configuration available to generate coverage information with the available compiler")
  endif ()
endif ()
