if (CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
  ...
  set(CMAKE_Fortran_FLAGS_COVERAGE "-O0 -g --coverage -fno-omit-frame-pointer -fcheck=all -ffpe-trap=invalid,zero,overflow -fbacktrace -finit-real=snan -finit-integer=-42 -finit-derived -Werror=realloc-lhs -finline-matmul-limit=0 -fsanitize=address -fsanitize=undefined -fno-sanitize-recover=all")
  set(CMAKE_Fortran_FLAGS_DEBUG    "-O0 -ggdb -fno-omit-frame-pointer -fcheck=all -ffpe-trap=invalid,zero,overflow -fbacktrace -finit-real=snan -finit-integer=-42 -finit-derived -Werror=realloc-lhs -finline-matmul-limit=0 -fsanitize=address -fsanitize=undefined -fno-sanitize-recover=all")
...
if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  ...
  set(CMAKE_CXX_FLAGS_COVERAGE     "-O0 -g --coverage -Wall -Werror -fsanitize=address -fsanitize=undefined -fno-sanitize-recover=all")
  set(CMAKE_CXX_FLAGS_DEBUG        "-O0 -ggdb -Wall -Werror -fsanitize=address -fsanitize=undefined -fno-sanitize-recover=all")
