...
void c_dbcsr_t_pgrid_create(const MPI_Fint *fcomm, int *c_dims, const int dims_size, dbcsr_t_pgrid *c_pgrid,
...
void c_dbcsr_t_pgrid_create_expert(const MPI_Fint *fcomm, int *c_dims, const int dims_size, dbcsr_t_pgrid *c_pgrid,
                                   const int *c_map1_2d, const int map1_2d_size, const int *c_map2_2d,
                                   const int map2_2d_size, const int *c_tensor_dims, const int *nsplit,
                                   const int *dimsplit);
...
void c_dbcsr_t_create_new(dbcsr_t_tensor *c_tensor, const char *c_name, const dbcsr_t_distribution c_dist,
...
void c_dbcsr_t_create_template(const dbcsr_t_tensor c_tensor_in, dbcsr_t_tensor *c_tensor, const char *c_name,
                               const void *c_dist, const int *c_map1_2d, const int map1_2d_size, const int *c_map2_2d,
                               const int map2_2d_size, const int *data_type);

void c_dbcsr_t_create_matrix(const dbcsr_matrix c_matrix_in, dbcsr_t_tensor *c_tensor, const int *c_order,
                             const char *c_name);
...
void c_dbcsr_t_get_${ndim}$d_block_${dsuffix}$(const dbcsr_t_tensor c_tensor, const int tensor_dim, const int *c_ind,
                                                 const int *c_sizes, ${ctype}$ *c_block, bool *c_found);

void c_dbcsr_t_put_${ndim}$d_block_${dsuffix}$(const dbcsr_t_tensor c_tensor, const int tensor_dim, const int *c_ind,
                                                 const int *c_sizes, const ${ctype}$ *c_block, const bool *c_summation,
                                                 const ${ctype}$ *c_scale);

void c_dbcsr_t_get_${ndim}$d_block_p_${dsuffix}$(const dbcsr_t_tensor c_tensor, const int *c_ind,
...
void c_dbcsr_t_contract_${
    dsuffix}$(const ${ctype}$ c_alpha, dbcsr_t_tensor c_tensor_1, dbcsr_t_tensor c_tensor_2, const ${ctype}$ c_beta,
               ...
               const int *c_map_1, const int c_map_1_size, const int *c_map_2, const int c_map_2_size,
               const int *c_bounds_1, const int *c_bounds_2, const int *c_bounds_3, const bool *c_optimize_dist,
...
void c_dbcsr_t_contract_index_${
    dsuffix}$(const ${ctype}$ c_alpha, dbcsr_t_tensor c_tensor_1, dbcsr_t_tensor c_tensor_2, const ${ctype}$ c_beta,
               ...
               const int map_1_size, const int *c_map_2, const int map_2_size, const int *c_bounds_1,
               const int *c_bounds_2, const int *c_bounds_3, const double *c_filter_eps, int *c_nblks_local,
               int *c_result_index, long long int result_index_size, int tensor3_dim);

void c_dbcsr_t_filter_${dsuffix}$(const dbcsr_t_tensor c_tensor, const ${ctype}$ c_eps, const int *c_method,
...
void c_dbcsr_t_get_stored_coordinates(const dbcsr_t_tensor c_tensor, const int tensor_dim, const int *c_ind_nd,
                                      int *c_processor);
...
void c_dbcsr_t_iterator_next_block(const dbcsr_t_iterator c_iterator, const int iterator_size, int *c_ind_nd,
...
void c_dbcsr_t_copy_matrix_to_tensor(const dbcsr_matrix c_matrix_in, dbcsr_t_tensor c_tensor_out,
                                     const bool *c_summation);

void c_dbcsr_t_copy_tensor_to_matrix(const dbcsr_t_tensor c_tensor_in, dbcsr_matrix c_matrix_out,
                                     const bool *c_summation);

void c_dbcsr_t_copy(const dbcsr_t_tensor c_tensor_in, const int tensor_dim, dbcsr_t_tensor c_tensor_out,
                    const int *c_order, const bool *c_summation, const int *c_bounds, const bool *c_move_data,
                    const int *c_unit_nr);
...
void c_dbcsr_t_get_info(const dbcsr_t_tensor c_tensor, const int tensor_dim, int *c_nblks_total, int *c_nfull_total,
                        int *c_nblks_local, int *c_nfull_local, int *c_pdims, int *my_ploc,
                        ${varlist("int nblks_local")}$, ${varlist("int nblks_total")}$,
                        ${varlist("int* c_blks_local")}$, ${varlist("int* c_proc_dist")}$,
                        ${varlist("int* c_blk_size")}$, ${varlist("int* c_blk_offset")}$,
...
void c_dbcsr_t_get_mapping_info(const dbcsr_t_tensor c_tensor, const int nd_size, const int nd_row_size,
                                const int nd_col_size, int *ndim_nd, int *ndim1_2d, int *ndim2_2d,
                                long long int *c_dims_2d_i8, int *c_dims_2d, int *c_dims_nd, int *c_dims1_2d,
                                int *c_dims2_2d, int *c_map1_2d, int *c_map2_2d, int *c_map_nd, int *base,
                                bool *c_col_major);
...
// --------------------------------------------------- //
#:for dsuffix, ctype in c_dtype_float_list
inline void c_dbcsr_t_get_block(const dbcsr_t_tensor c_tensor, const int *c_ind, const int *c_sizes,
                                ${ctype}$ *c_block, bool *c_found) {
...
#:for ndim in ndims
  case ${ndim}$:
    c_dbcsr_t_get_${ndim}$d_block_${dsuffix}$(c_tensor, tensor_dim, c_ind, c_sizes, c_block, c_found);
    break;
#:endfor
  }
}

inline void c_dbcsr_t_get_block_p(const dbcsr_t_tensor c_tensor, const int *c_ind, ${ctype}$ **c_block,
                                  bool *c_found) {
...
#:for ndim in ndims
  case ${ndim}$:
    c_dbcsr_t_get_${ndim}$d_block_p_${dsuffix}$(c_tensor, c_ind, c_block, c_found);
    break;
#:endfor
  }
}
...
#:for dsuffix, ctype in c_dtype_float_list
inline void c_dbcsr_t_put_block(const dbcsr_t_tensor c_tensor, const int *c_ind, const int *c_sizes,
...
inline void c_dbcsr_t_iterator_next_block(const dbcsr_t_iterator c_iterator, int *c_ind_nd, int *c_blk, int *c_blk_p,
...
#:for dsuffix, ctype in c_dtype_float_list
inline void c_dbcsr_t_filter(const dbcsr_t_tensor c_tensor, const ${ctype}$ c_eps, const int *c_method,
                             const bool *c_use_absolute) {
