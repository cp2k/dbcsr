...
typedef int (*TransposeLauncher)(const int *param_stack, int offset, int nblks, double *buffer, int m, int n,
...
int libsmm_acc_benchmark(libsmm_acc_benchmark_t *handle, int mat_m, int mat_n, int mat_k, int nkernel,
