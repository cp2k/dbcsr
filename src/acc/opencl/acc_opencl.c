...
#  endif
    ...
    if (EXIT_SUCCESS != c_dbcsr_acc_opencl_devuid(env_devmatch, &c_dbcsr_acc_opencl_config.devmatch)) {
...
#  endif
          ...
          if (EXIT_SUCCESS != c_dbcsr_acc_opencl_device_uid(active_id, &c_dbcsr_acc_opencl_config.device[thread_id].uid)) {
