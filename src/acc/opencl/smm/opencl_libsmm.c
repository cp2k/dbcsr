...
#  if !defined(OPENCL_LIBSMM_DEBUG_TRANS) && defined(OPENCL_LIBSMM_DEBUG) && (1 < OPENCL_LIBSMM_DEBUG || 0 > OPENCL_LIBSMM_DEBUG)
...
#    if !defined(OPENCL_LIBSMM_DEBUG_TRANS)
              ...
              if (0 < entry->nexec) {
                ...
                opencl_libsmm_write_trans_params(
                  stderr, 1 /*only_key*/, desc, NULL /*config*/, NULL /*delim*/, NULL /*begin*/, NULL /*close*/);
                fprintf(stderr, "=");
                opencl_libsmm_write_trans_params(
                  stderr, 1 /*only_key*/, desc, &dummy, NULL /*delim*/, NULL /*begin*/, NULL /*close*/);
...
#      endif
            if (4 <= c_dbcsr_acc_opencl_config.verbosity || 0 > c_dbcsr_acc_opencl_config.verbosity) {
              ...
              fprintf(stderr, "=");
              opencl_libsmm_write_trans_params(
                stderr, 1 /*only_key*/, &key, config, NULL /*delim*/, NULL /*begin*/, NULL /*close*/);
...
#    endif
              ...
              if (new_config.wgsize[kernel_idx] <= wgsize_max) { /* SMMs can be potentially handled by device */
                ...
                nchar = LIBXSMM_SNPRINTF(build_params, sizeof(build_params),
                  ...
                  NULL == env_nrepeat ? 1 : atoi(env_nrepeat), new_config.lu, m_max, n_max, k_max, new_config.bs, new_config.bm,
                  new_config.bn, new_config.bk, tname, datatype, 0 == new_config.nz ? "" : "-DATOMIC_INC_NZ",
                  0 == new_config.al ? "" : "-DAL", 0 == new_config.tb ? "" : "-DTRACK_B", 0 != new_config.tc ? "-DTRACK_C" : "",
