...
void c_dbcsr_distribution_new_aux(dbcsr_distribution *dist, MPI_Fint *fcomm, int *row_dist, int row_dist_size,
                                  int *col_dist, int col_dist_size);

inline void c_dbcsr_distribution_new(dbcsr_distribution *dist, MPI_Comm comm, int *row_dist, int row_dist_size,
                                     int *col_dist, int col_dist_size) {
  MPI_Fint fcomm = MPI_Comm_c2f(comm);
...
void c_dbcsr_create_new(dbcsr_matrix *c_matrix, const char *c_name, const dbcsr_distribution, const char c_matrix_type,
                        const int *c_row_blk_size, const int c_row_size, const int *c_col_blk_size,
                        const int c_col_size, const int *c_nze, const int *c_data_type, const bool *c_reuse,
                        const bool *c_reuse_arrays, const bool *c_mutable_work, const char *c_replication_type);

void c_dbcsr_create_template(dbcsr_matrix *c_matrix, const char *c_name, const dbcsr_matrix c_template,
                             const dbcsr_distribution c_dist, const char *c_matrix_type, const int *c_row_blk_size,
                             const int c_row_size, const int *c_col_blk_size, const int c_col_size, const int *c_nze,
                             const int *c_data_type, const bool *c_reuse_arrays, const bool *c_mutable_work,
...
void c_dbcsr_complete_redistribute(const dbcsr_matrix c_matrix, dbcsr_matrix c_redist, const bool *c_keep_sparsity,
                                   const bool *c_summation);

void c_dbcsr_filter(dbcsr_matrix c_matrix, const double *c_eps, const int *c_method, const bool *c_use_absolute,
...
void c_dbcsr_copy(dbcsr_matrix *c_matrix_b, const dbcsr_matrix c_matrix_a, const char *c_name,
                  const bool *c_keep_sparsity, const bool *c_shallow_data, const bool *c_keep_imaginary,
...
void c_dbcsr_iterator_start(dbcsr_iterator *c_iterator, const dbcsr_matrix c_matrix, const bool *c_shared,
                            const bool *c_dynamic, const bool *c_dynamic_byrows, const bool *c_contiguous_pointers,
                            const bool *c_read_only);

bool c_dbcsr_iterator_blocks_left(const dbcsr_iterator c_iterator);

void c_dbcsr_iterator_next_block_index(const dbcsr_iterator c_iterator, int *c_row, int *c_column, int *c_blk,
                                       int *c_blk_p);
...
void c_dbcsr_hadamard_product(const dbcsr_matrix c_matrix_a, const dbcsr_matrix c_matrix_b, dbcsr_matrix c_matrix_c,
...
void c_dbcsr_function_of_elements(dbcsr_matrix c_matrix, const int c_func, const double *c_a0, const double *c_a1,
                                  const double *c_a2);
...
void c_dbcsr_get_info(const dbcsr_matrix c_matrix, int *c_nblkrows_total, int *c_nblkcols_total, int *c_nfullrows_total,
                      int *c_nfullcols_total, int *c_nblkrows_local, int *c_nblkcols_local, int *c_nfullrows_local,
                      int *c_nfullcols_local, int *c_my_prow, int *c_my_pcol, int *c_local_rows, int *c_local_cols,
                      int *c_proc_row_dist, int *c_proc_col_dist, int *c_row_blk_size, int *c_col_blk_size,
                      int *c_row_blk_offset, int *c_col_blk_offset, dbcsr_distribution *c_distribution, char **c_name,
...
#:endfor
              ...
              void c_dbcsr_distribution_get_aux(const dbcsr_distribution c_dist, int **c_row_dist, int **c_col_dist,
                                                int *c_nrows, int *c_ncols, bool *c_has_threads, MPI_Fint *c_group,
                                                int *c_mynode, int *c_numnodes, int *c_nprows, int *c_npcols,
                                                int *c_myprow, int *c_mypcol, int **c_pgrid, bool *c_subgroups_defined,
                                                int *c_prow_group, int *c_pcol_group);

              inline void c_dbcsr_distribution_get(const dbcsr_distribution c_dist, int **c_row_dist, int **c_col_dist,
                                                   int *c_nrows, int *c_ncols, bool *c_has_threads, MPI_Comm *c_group,
                                                   int *c_mynode, int *c_numnodes, int *c_nprows, int *c_npcols,
                                                   int *c_myprow, int *c_mypcol, int **c_pgrid,
                                                   bool *c_subgroups_defined, int *c_prow_group, int *c_pcol_group) {

                MPI_Fint fgroup;
                c_dbcsr_distribution_get_aux(c_dist, c_row_dist, c_col_dist, c_nrows, c_ncols, c_has_threads, &fgroup,
                                             c_mynode, c_numnodes, c_nprows, c_npcols, c_myprow, c_mypcol, c_pgrid,
              ...
              void c_dbcsr_get_stored_coordinates(const dbcsr_matrix matrix, const int row, const int col,
                                                  int *processor);
              ...
              void c_dbcsr_binary_read_aux(const char *c_filepath, dbcsr_distribution c_distribution,
                                           MPI_Fint c_groupid, dbcsr_matrix *c_matrix_new);

              inline void c_dbcsr_binary_read(const char *c_filepath, dbcsr_distribution c_distribution, MPI_Comm comm,
